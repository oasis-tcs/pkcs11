---
title: 'PKCS #11 Profiles Version 3.2'
author: 'Committee Specification 01'
date: '14 November 2025'
abstract: |
  **This stage:**

  <https://docs.oasis-open.org/pkcs11/pkcs11-profiles/v3.2/cs01/pkcs11-profiles-v3.2-cs01.docx> (Authoritative)
  ...
  **Chairs:**
  ...
  Greg Scott (greg.scott@cryptsoft.com), [Cryptsoft Pty Ltd](https://cryptsoft.com/)

  **Editor:**

  Tim Hudson (tjh@cryptsoft.com), [Cryptsoft Pty Ltd](https://cryptsoft.com/)
  ...
  * PKCS #11 Profiles Version 3.1. Edited by Tim Hudson. OASIS Standard.
    Latest stage: <https://docs.oasis-open.org/pkcs11/pkcs11-profiles/v3.1/pkcs11-profiles-v3.1.html>.

  This specification is related to:

  * PKCS #11 Specification Version 3.2. Edited by Dieter Bong and Greg Scott.
  ...
  **Status:**
  ...
  This document was last revised or approved by the OASIS PKCS 11 TC on the
  ...
  web page at <https://www.oasis-open.org/committees/pkcs11/>.
  ...
  **Citation format:**
  ...
  When referencing this document, the following citation format should be used:
    **[PKCS11-Profiles-v3.2]**

  _PKCS #11 Profiles Version 3.2._ Edited by Tim Hudson. 15 April 2025.
   OASIS Committee Specification 01. <https://docs.oasis-open.org/pkcs11/pkcs11-profiles/v3.2/cs01/pkcs11-profiles-v3.2-cs01.html>.
  ...
  **Notices:**
  ...
  [https://www.oasis-open.org/policies-guidelines/ipr/]. For complete copyright
