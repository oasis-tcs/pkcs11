...
at the OASIS website: [https://www.oasis-open.org/policies-guidelines/ipr/].
...
owner and developer of this document, and should be used only to refer to the
organization and its official outputs. OASIS welcomes reference to, and
implementation and use of, documents, while reserving the right to enforce its
